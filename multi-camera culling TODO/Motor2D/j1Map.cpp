			...
			for (int y = 0; y < data.height; ++y)
			{
					for (int x = 0; x < data.width; ++x)
					{
							...
							if (tile_id > 0)
							{
								...
								//If now the blit function receives a camera it will only print in this camera
								//but if the blit doesn't receive any camera will print the texture in all cameras that are in the array/list
